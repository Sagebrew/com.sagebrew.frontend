...
sed "s/<TAG>/$SHA1/" < ~/com.sagebrew.frontend/deployment/Dockerrun.aws.sys.master.json.template > $DOCKERRUN_FILE_SYS
sed "s/<TAG>/$SHA1/" < ~/com.sagebrew.frontend/deployment/Dockerrun.aws.master.json.template > $DOCKERRUN_FILE
